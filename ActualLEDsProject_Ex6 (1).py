# git clone https://github.com/Majdawad88/ECET411_actuallLEDsProject.git
...
def greenClick():
        ...
        if counterReminder == 1:
                greenLabel = Label(root, text = "Green LED ON", fg = "white", bg ="green")
...
greenLedButton = Button(root, text="GREEN",command=lambda:greenClick(), padx = 10, pady = 0, fg = "white", bg = "green")
greenLabel = Label(root, text = "Green LED OFF", fg = "white", bg ="green")
